...
<Properties>
  ...
  <Property name="open_in_browser" type="string" required="false" value="">
    ...
    The value specifies the path to open, e.g. "/" or "/dashboard".
  </Property>
...
### Kubernetes Remote Service

Exposes the Kubernetes port `9090` for the Kubernetes service `fake-service` 
