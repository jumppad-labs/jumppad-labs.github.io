...
<Properties>
  ...
  <Property name="open_in_browser" type="bool" required="false" value="false">
    Should the Nomad UI be automatically opened in the browser when the cluster is created.
  </Property>
  ...
  <Property name="server_container_name" type="string" required="false" value="" readonly>
  ...
  <Property name="client_container_name" type="[]string" required="false" value="" readonly>
...
<Properties>
  <Property name="docker" type="#docker_config" required="false" value="">
    Docker configuration for the Nomad cluster.
  </Property>
</Properties>
