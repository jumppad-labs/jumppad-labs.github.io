...
<Properties>
  <Property name="network" type="#network_attachment" required="true" value="4646">
  ...
  <Property name="image" type="#image" required="false" value="4646">
  ...
  <Property name="environment" type="map[string]string" required="false" value="4646">
  ...
  <Property name="server_config" type="string" required="false" value="4646">
    Path to a file containing custom Nomad server config to use when creating 
    the server.
  </Property>
  
  <Property name="client_config" type="string" required="false" value="4646">
    Path to a file containing custom Nomad client config to use when creating 
    the server.
  </Property>
  
  <Property name="consul_config" type="string" required="false" value="4646">
    Path to a file containing custom Consul agent config  to use when creating
    the client.
  </Property>
  
  <Property name="volume" type="#volume" required="false" value="4646">
  ...
  <Property name="copy_image" type="#image" required="false" value="4646">
  ...
  <Property name="port" type="#port" required="false" value="4646">
  ...
  <Property name="port_range" type="#port_range" required="false" value="4646">
  ...
  <Property name="connector_port" type="int" required="false" value="4646" readonly>
  ...
  <Property name="config_dir" type="string" required="false" value="4646" readonly>
    Local directory where the server and client configuration is stored.
  </Property>
  
  <Property name="server_fqrn" type="string" required="false" value="4646" readonly>
  ...
  <Property name="client_fqrn" type="[]string" required="false" value="4646" readonly>
  ...
  <Property name="external_ip" type="string" required="false" value="4646" readonly>
