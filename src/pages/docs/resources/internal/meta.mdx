...
<Properties>
  ...
  <Property name="resource_id" type="string" required="false" value="" readonly>
    The unique `resource_id` for the resource, this value can be used in interpolation
    syntax to reference properties for a resource.
  </Property>
  
  <Property name="resource_name" type="string" required="false" value="" readonly>
  ...
  <Property name="resource_type" type="string" required="true" value="" readonly>
  ...
  <Property name="resource_module" type="string" required="false" value="" readonly>
  ...
  <Property name="resource_file" type="string" required="false" value="" readonly>
