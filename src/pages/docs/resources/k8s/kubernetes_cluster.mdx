...
<Properties>
  ...
  <Property name="image" type="#image" required="false" value="">
    Image defines a Docker image to use when creating the container. By default the Kubernetes
  ...
  <Property name="copy_image" type="#image" required="false" value="">
    ...
    This image is added to the Kubernetes cluster's docker cache enabling pods to use
    images that may not be in a remote registry.
  ...
  <Property name="kube_config" type="#kube_config" required="false" value="" readonly>
    Details for the Kubenetes config file that can be used to interact with the 
    cluster.
  </Property>
  
  <Property name="container_name" type="string" required="false" value="" readonly>
    The fully qualified resource name for the Kubernetes cluster, this value can be
  ...
  <Property name="external_ip" type="string" required="false" value="" readonly>
    Local IP address of the Kubernetes cluster, this property can be used to
    construct the Kubernetes API address.
...
<Properties>
  <Property name="docker" type="#docker_config" required="false" value="">
...
<Properties>
  <Property name="no_proxy" type="[]string" required="false" value="">
    A list of docker registries that should not be proxied.
  </Property>
  <Property name="insecure_registries" type="[]string" required="false" value="">
...
<Properties>
  ...
  <Property name="ca" type="string" required="false" value="" readonly>
    The certificate authority used to secure the cluster API. This value is base64 encoded.
  </Property>
  <Property name="client_certificate" type="string" required="false" value="" readonly>
    The client certificate authority used authenticate to the cluster API. This value is base64 encoded.
  </Property>
  <Property name="client_key" type="string" required="false" value="" readonly>
...
## Image Caching
Kubernetes clusters do not share the local machines Docker image cache. Each 
node in a cluster has it's own unqiue cache.

To save bandwidth all containers launched in the Kubernetes cluster pulled through
