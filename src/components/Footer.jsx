...
function SmallPrint() {
  return (
    <div className="flex flex-col lg:px-4 items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 dark:border-white/5 sm:flex-row">
      <p className="text-xs text-zinc-600 dark:text-zinc-400">
        &copy; Copyright {new Date().getFullYear()}. All rights reserved.
      </p>
      <div className="flex gap-4">
        <SocialLink href="https://github.com/jumppad-labs" icon={GitHubIcon}>
          Follow us on GitHub
        </SocialLink>
        <SocialLink href="https://discord.gg/ZuEFPJU69D" icon={DiscordIcon}>
...
export function Footer({children}) {
  return (
    <footer className="mx-auto max-w-2xl px-6 space-y-10 pb-16 lg:max-w-7xl">
      {children}
      <SmallPrint />
    </footer>
  )
